...
test_json = "/home/devanggupta/prj/PMC-VQA/pmc_vqa_test_llava.json"
    ...
    for batch in loader:
        ...
        for i, out in enumerate(output_ids):
            ...
            results.append({
                ...
                "question": batch["raw_items"][i]["conversations"][1]["value"],
                "prediction": pred,
...
out_path = "pmc_vqa_llava_baseline_predictions.json"
